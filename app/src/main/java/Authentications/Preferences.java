...
public class Preferences {
    ...
    static final String PREF_Type_ID = "Employee";
    ...
    public static void SetUserID(Context ctx, int userId,int employeeId , Boolean isCustomer)
    {
        SharedPreferences.Editor editor = getSharedPreferences(ctx).edit();
        editor.putInt(PREF_USER_ID, userId);
        editor.putInt(PREF_Type_ID, employeeId);
    ...
    public static int GetLoggedInUserCustomerOREmployeeID(Context context){
        return getSharedPreferences(context).getInt(PREF_Type_ID,0);
    }
